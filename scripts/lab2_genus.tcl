...
set _OUTPUTS_PATH ../export/$DESIGN
...
set_db / .init_hdl_search_path $RAK_TOP/RTL
...
set_db / .lef_library [list gsclib045_tech.lef gsclib045_macro.lef pll.lef   CDK_S128x16.lef  CDK_S256x16.lef  CDK_R512x16.lef]
...
write_db -common ${DESIGN}-writeScript-analyzeAllScanChains
